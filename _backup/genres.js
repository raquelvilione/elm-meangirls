...
var _user$project$Aliases$DadosLogin = F3(
	function (a, b, c) {
...
var _user$project$Aliases$Temporadas = F4(
	function (a, b, c, d) {
		return {numEpisodios: a, id: b, poster: c, numTemporada: d};
	});
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'idApi',
				_1: _elm_lang$core$Json_Encode$int(_p3.id_)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'name',
					_1: _elm_lang$core$Json_Encode$string(_p3.nome)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'vote_average',
						_1: _elm_lang$core$Json_Encode$float(_p3.mediaNota)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_0: 'poster_path',
							_1: _elm_lang$core$Json_Encode$string(
								A2(_elm_lang$core$Maybe$withDefault, '', _p3.poster))
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'first_air_date',
								_1: _elm_lang$core$Json_Encode$string(_p3.dataInicio)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'popularity',
									_1: _elm_lang$core$Json_Encode$float(_p3.popularidade)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Decodes$decodePopulares = A2(
	...
	_elm_lang$core$Json_Decode$list(
		A8(
			...
			A2(_elm_lang$core$Json_Decode$field, 'popularity', _elm_lang$core$Json_Decode$float),
			A2(_elm_lang$core$Json_Decode$field, 'overview', _elm_lang$core$Json_Decode$string))));
var _user$project$Decodes$decodeRespLogin = A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int);
...
var _user$project$BuscaGenero$viewGeneros = function (genero) {
	return A2(
...
var _user$project$BuscaGenero$tiraAspas = function (palavra) {
	return A2(
...
var _user$project$BuscaGenero$viewStock = function (model) {
	return A2(
							...
							_0: A2(
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										_user$project$BuscaGenero$tiraAspas(
...
var _user$project$BuscaGenero$Model = F4(
	function (a, b, c, d) {
		return {mensagem: a, generos: b, generoEscolhido: c, seriesGenero: d};
	});
var _user$project$BuscaGenero$init = A4(
	_user$project$BuscaGenero$Model,
	'',
	{ctor: '[]'},
	'',
	{ctor: '[]'});
var _user$project$BuscaGenero$RespostaSG = function (a) {
	return {ctor: 'RespostaSG', _0: a};
};
var _user$project$BuscaGenero$getSeriesGenero = function (s) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$BuscaGenero$RespostaSG,
		A2(
...
var _user$project$BuscaGenero$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'RespostaG':
			...
			case 'Buscar':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$BuscaGenero$getSeriesGenero(model.generoEscolhido)
				};
			default:
				var _p2 = _p0._0;
				if (_p2.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{seriesGenero: _p2._0, mensagem: 'blz'}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
		}
	});
var _user$project$BuscaGenero$Buscar = {ctor: 'Buscar'};
var _user$project$BuscaGenero$GeneroEscolhido = function (a) {
	return {ctor: 'GeneroEscolhido', _0: a};
};
var _user$project$BuscaGenero$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$BuscaGenero$GeneroEscolhido),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _user$project$BuscaGenero$viewGeneros, model.generos)),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$BuscaGenero$Buscar),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$BuscaGenero$viewStock, model.seriesGenero)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$BuscaGenero$RespostaG = function (a) {
	return {ctor: 'RespostaG', _0: a};
};
var _user$project$BuscaGenero$getGeneros = A2(
	_elm_lang$http$Http$send,
	_user$project$BuscaGenero$RespostaG,
...
var _user$project$BuscaGenero$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$BuscaGenero$init, _1: _user$project$BuscaGenero$getGeneros},
		view: _user$project$BuscaGenero$view,
		update: _user$project$BuscaGenero$update,
...
var Elm = {};
Elm['Aliases'] = Elm['Aliases'] || {};
if (typeof _user$project$Aliases$main !== 'undefined') {
    _user$project$Aliases$main(Elm['Aliases'], 'Aliases', undefined);
}
Elm['BuscaGenero'] = Elm['BuscaGenero'] || {};
if (typeof _user$project$BuscaGenero$main !== 'undefined') {
    _user$project$BuscaGenero$main(Elm['BuscaGenero'], 'BuscaGenero', undefined);
}
