...
var Elm = {};
Elm['AiringToday'] = Elm['AiringToday'] || {};
if (typeof _user$project$AiringToday$main !== 'undefined') {
    _user$project$AiringToday$main(Elm['AiringToday'], 'AiringToday', undefined);
}
...
Elm['ProcurarSerie'] = Elm['ProcurarSerie'] || {};
if (typeof _user$project$ProcurarSerie$main !== 'undefined') {
    _user$project$ProcurarSerie$main(Elm['ProcurarSerie'], 'ProcurarSerie', undefined);
}
