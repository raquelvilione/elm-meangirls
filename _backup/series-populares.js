...
var _user$project$Aliases$Temporadas = F2(
	function (a, b) {
		return {id: a, episode_count: b};
	});
var _user$project$Aliases$Serie = F2(
	function (a, b) {
		return {serie: a, temporadas: b};
	});
...
var _user$project$SeriesPopulares$Model = F4(
	function (a, b, c, d) {
		return {mensagem: a, populares: b, temporadas: c, serieFinal: d};
	});
var _user$project$SeriesPopulares$init = function () {
	var popular = A7(
		_user$project$Aliases$Populares,
		0,
		'',
	...
	return A4(
		...
		{ctor: '[]'},
		A2(
			_user$project$Aliases$Serie,
			popular,
			{ctor: '[]'}));
}();
var _user$project$SeriesPopulares$RespostaTemp = function (a) {
	return {ctor: 'RespostaTemp', _0: a};
};
var _user$project$SeriesPopulares$getTemporadas = function (valor) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$SeriesPopulares$RespostaTemp,
		A2(
...
var _user$project$SeriesPopulares$SubmitTemporada = function (a) {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$SeriesPopulares$SubmitTemporada(popular.id_)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('oi'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.temporadas)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		switch (_p0.ctor) {
			...
			case 'SubmitTemporada':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$SeriesPopulares$getTemporadas(
...
Elm['SeriesPopulares'] = Elm['SeriesPopulares'] || {};
if (typeof _user$project$SeriesPopulares$main !== 'undefined') {
    _user$project$SeriesPopulares$main(Elm['SeriesPopulares'], 'SeriesPopulares', undefined);
}
